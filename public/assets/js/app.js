...
function applyAccount(phone) { state.account = phone; state.orderAuthorization = null; $('#contact').value = phone; $('#accountWelcome').textContent = `欢迎你：${phone}`; $('#currentAccountPhone').textContent = phone; $('#accountModal').classList.add('hidden'); }
