...
$('#quantity').addEventListener('change', updatePrice); $('#payButton').addEventListener('click', createOrder); $('#closeModal').addEventListener('click', () => { $('#paymentModal').classList.add('hidden'); $('#paymentQrImage').removeAttribute('src'); clearInterval(state.timer); });
